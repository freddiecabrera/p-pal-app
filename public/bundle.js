...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Locales = __webpack_require__(231);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'locales', component: _Locales2.default })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Locales = _react2.default.createClass({
	  displayName: 'Locales',
	  getInitialState: function getInitialState() {
	    return {
	      modulOn: false,
	  ...
	  triggerModul: function triggerModul() {
	    if (this.state.modulOn === true) {
	      return this.setState({ modulOn: false });
	    }
	    return this.setState({ modulOn: true });
	  },
	  checkForCountry: function checkForCountry(country) {
	    var _this = this;

	    this.state.data.map(function (data) {
	      if (data.name === country) {
	        return _this.getCountryData(country);
	      } else {
	        return 'No data from that country';
	      }
	    });
	  },
	  dataReducer: function dataReducer(collection, target) {
	    for (var key in collection) {
	      ...
	      } else if (key !== target && _typeof(collection[key]) === 'object') {
	        var nestedCollection = collection[key];
	        for (var keyTwo in nestedCollection) {
	          if (keyTwo === target) {
	  ...
	  getCountryData: function getCountryData(country) {
	    ...
	    _axios2.default.get('https://api.github.com/repos/unicode-cldr/cldr-misc-full/contents/main/' + country + '/delimiters.json').then(function (respone) {
	      _this2.setState({ countryData: JSON.parse(_this2.b64DecodeUnicode(respone.data.content)) });
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _axios2.default.get('https://api.github.com/repos/unicode-cldr/cldr-misc-full/contents/main').then(function (respone) {
	      _this3.setState({ data: respone.data, fetching: false });
	    }).catch(function (error) {
	  ...
	  render: function render() {
	    ...
	    return this.state.fetching ? _react2.default.createElement(_Loader2.default, null) : _react2.default.createElement(
	      'div',
	      { className: 'container', style: { marginTop: '6em' } },
	      _react2.default.createElement(
	        'div',
	        { className: 'row' },
	        _react2.default.createElement(
	          'form',
	          { className: 'col s12', onSubmit: this.handleFormSubmit },
	          _react2.default.createElement(
	            'div',
	            { className: 'row' },
	            !this.state.submitted ? _react2.default.createElement(
	              ...
	              _react2.default.createElement('input', { className: 'property-input', type: 'text', ref: 'name', value: this.state.name, onChange: this.handleNameChange }),
	              _react2.default.createElement(
	                'label',
	                null,
	                'Country'
	              ),
	              this.state.name.length !== 0 ? _react2.default.createElement(
	                'span',
	                { style: { color: 'red' } },
	                'Countries are case sensitive'
	              ) : null
	            ) : _react2.default.createElement(
	              'div',
	              { className: 'input-field col s12' },
	              _react2.default.createElement('input', { className: 'property-input', type: 'text', ref: 'property', value: this.state.property, onChange: this.handleChange }),
	              _react2.default.createElement(
	                'label',
	                null,
	                'Property'
	          ...
	          _react2.default.createElement(
	            ...
	            !this.state.submitted ? _react2.default.createElement(
	              'button',
	              { type: 'submit', className: 'waves-effect waves-light btn', onClick: this.checkForCountry.bind(null, this.state.name) },
	              'Enter'
	            ) : _react2.default.createElement(
	              'div',
	              null,
	              _react2.default.createElement(
	                'button',
	                { type: 'submit', className: 'btn-floating btn-large waves-effect waves-light indigo accent-4', onClick: this.addProperty.bind(null, this.state.property) },
	                _react2.default.createElement(
	                  'i',
	              ...
	              _react2.default.createElement(
	                'button',
	                { type: 'button', className: 'waves-effect waves-light btn', onClick: this.resetForm },
	                'New Search'
	              )
	            )
	          )
	      ...
	      _react2.default.createElement(
	        'div',
	        null,
	        this.state.addedProperties.map(function (item) {
	          return _react2.default.createElement(
	            'ul',
	            { className: 'collection with-header z-depth-1', key: item },
	            _react2.default.createElement(
	              'span',
	              { className: 'secondary-content', onClick: _this4.deleteProperty.bind(null, item) },
	              _react2.default.createElement(
	                'i',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'code',
	                  null,
	                  _this4.dataReducer(_this4.state.countryData, item)
	                )
	              )
	            )
	          );
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'fixed-action-btn horizontal', style: { top: '45px', right: '24px' } },
	        _react2.default.createElement(
	          'a',
	          { className: 'btn-floating btn-large indigo accent-4 waves-effect waves-light', onClick: this.triggerModul },
	          _react2.default.createElement(
	            'i',
	      ...
	      this.state.modulOn ? _react2.default.createElement(
	        'div',
	        { className: 'my-modul z-depth-4' },
	        _react2.default.createElement(
	          'span',
	          { className: 'modul-clear', onClick: this.triggerModul },
	          _react2.default.createElement(
	            'i',
	            { className: 'material-icons clear-icon' },
	            'clear'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = function Loader() {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement('div', { id: 'main', className: 'loader' }),
	    _react2.default.createElement('div', { className: 'ball-one loader' }),
	    _react2.default.createElement('div', { className: 'ball-two loader' }),
	    _react2.default.createElement('div', { className: 'ball-three loader' })
	  );
	};
